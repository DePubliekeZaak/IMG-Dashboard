...
import { ChartAvgLine, ChartBackgroundArea, ChartRaggedLine, ChartWeekGrid, HtmlCircle, HtmlTriangle, HtmlTotals, HtmlNumber, HtmlNumberNew, HtmlHeader, HtmlLink, HtmlPopup, HtmlSegment } from '../chart-elements/module';
import * as d3 from "d3";

export class TotalPlus  {
    ...
    init() {
     ...
     //   this.chartSVG = new ChartSVG(this.elementID, this.config, this.dimensions, this.svg);
        ...
        // this.htmlTriangle = new HtmlTriangle(this.config,this.dataMapping,this.element,'');
