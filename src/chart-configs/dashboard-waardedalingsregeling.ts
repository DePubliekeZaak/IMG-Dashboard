...
export const dashboardWaardedalingsRegeling: (GraphObject | IGraphMapping)[] = [
  {
    ...
    header: "Toegekend",
    description:
      "Het aantal nieuwe schademeldingen dat afgelopen week is binnengekomen.",
    endpoint: "waardedaling",
    segment: "all",
    elementClasslist: [
      "img-graph-container",
      "img-graph-container-4",
      "img-graph-container-bol",
    ],
  },
  {
  ...
  },
  {
    ...
    elementClasslist: [
      "img-graph-container",
      "img-graph-container-12",
      "img-graph-container-trendline",
      "img-graph-container-vertical-padding",
    ],
  },
  {
