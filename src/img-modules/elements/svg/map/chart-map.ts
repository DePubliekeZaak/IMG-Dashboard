...
import { convertToCurrency, shortenCurrency, slugify } from '@local/d3-services';
...
export default class ChartMap   {
    ...
    init() {
        ...
        var b = [
            ...
            s = .15 / Math.max((b[1][0] - b[0][0]) / this.ctrlr.dimensions.svgWidth, (b[1][1] - b[0][1]) / this.ctrlr.dimensions.height),
