...
export interface IDataService {
    ...
    data: any,
    ctrlr: any,
    call: (params: string, pageConfig: IGraphMapping[], segment: string, update: boolean, htmlContainer: HTMLElement) => Promise<string> 
...
export class DataService implements IDataService {
    ...
    async call(params: string, pageConfig, segment: string, update: boolean, htmlContainer: HTMLElement) : Promise<string> {
