    ...
    redraw(data) {
        ...
        if (this.ctrlr.svg.averageLabel) {
            this.ctrlr.svg.averageLabel
                .attr("dx", -40)
                .attr("dy", function (d) {
                return (self.ctrlr.scales.y.scale(Math.round(av)) - self.ctrlr.scales.y.scale(data.slice[0][self.ctrlr.parameters.y]) < 0) ? 3 : 3;
            })
                .text('gemiddeld:');
        }
    }
}
exports.ChartAvgLine = ChartAvgLine;
