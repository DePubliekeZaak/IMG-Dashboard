...
class DashboardInfo {
    constructor() {
        this.elementLabel = document.querySelector('aside.info article h2.label');
        this.elementText = document.querySelector('aside.info article div');
    }
    update(mapping) {
...
//# sourceMappingURL=dashboard_info.js.map